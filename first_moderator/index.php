						...
						echo "
						    <tbody>
								<tr>
									...
									<td style='display: none;'>" .$tutor['sum_typ1']."</td>
									<td style='display: none;'>" .$tutor['sum_typ2']."</td>
									<td style='display: none;'>" .$tutor['sum_typ3']."</td>
									<td style='display: none;'>" .$tutor['sum_typ4']."</td>
									<td>" . $sum_val . "</td>
