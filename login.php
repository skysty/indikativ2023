...
<body>
	...
	<p style = "font-size: 24px; text-align: center; color: #db261b; font-weight: bold;"> <a target = "_blank" href = "../files/instructions.pdf">Cайтқа кіру нұсқаулығын оқыңыз</a></p>
				...
				<form action = "doLogin.php" method = "post">
					<table>
						<tr>
							...
							<td>
								<input type = "text" name = "login" value = "" placeholder = "Логинді теріңіз">
							</td>
						</tr>
						<tr>
							<td>
								<strong>Құпия сөз</strong>
							</td>
							<td>
								<input type = "password" name = "password" placeholder = "Құпия сөзді теріңіз">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type = "submit" name = "submit_login" value = "Кіру">
							</td>
						</tr>
                        <tr>
							<td>
							...
							<td>
								<a href="mail/index.php"><br>Құпия сөзді ұмыттым?</br></a>
							</td>
						</tr>                                               
					</table>
				</form>
